...
export default function Dashboard() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 flex-grow w-full space-y-8 transition-colors">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
            Real-time constituent issues monitoring, automated priority ranking, and regional governance analytics.
          </p>
        </div>
        <div className="flex gap-2 shrink-0">
          <Link
            to="/admin/analytics"
            className="inline-flex items-center gap-2 rounded-xl bg-govblue-600 hover:bg-govblue-700 text-white px-4 py-2 text-sm font-semibold shadow-sm transition-all justify-center"
          >
          ...
          <button
            onClick={fetchData}
            disabled={loading}
            className="inline-flex items-center gap-2 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-4 py-2 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 active:bg-slate-100 disabled:opacity-50 transition-all shadow-sm shrink-0 justify-center font-['Inter']"
          >
            <svg
      ...
      {/* Error Banner */}
      {error && (
        <div className="rounded-xl border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-950/40 p-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-red-800 dark:text-red-300 font-['Outfit']">Data Sync Error</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 flex items-center justify-between">
            <div>
              ...
              <span className="text-3xl font-extrabold text-slate-900 dark:text-white font-['Outfit']">{stats.total}</span>
            </div>
            <div className="h-12 w-12 rounded-xl bg-govblue-50 dark:bg-govblue-950/70 border border-govblue-100 dark:border-govblue-800 flex items-center justify-center text-govblue-600 dark:text-govblue-300">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 flex items-center justify-between">
            <div>
              ...
              <span className="text-3xl font-extrabold text-rose-600 dark:text-rose-400 font-['Outfit']">{stats.highUrgency}</span>
            </div>
            <div className="h-12 w-12 rounded-xl bg-rose-50 dark:bg-rose-950/70 border border-rose-100 dark:border-rose-800 flex items-center justify-center text-rose-600 dark:text-rose-300">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 flex items-center justify-between">
            <div>
              ...
              <span className="text-3xl font-extrabold text-slate-900 dark:text-white font-['Outfit']">{stats.avgPriority}<span className="text-sm font-medium text-slate-400">/100</span></span>
            </div>
            <div className="h-12 w-12 rounded-xl bg-amber-50 dark:bg-amber-950/70 border border-amber-100 dark:border-amber-800 flex items-center justify-center text-amber-600 dark:text-amber-300">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 flex items-center justify-between">
            <div>
              ...
              <span className="text-3xl font-extrabold text-slate-900 dark:text-white font-['Outfit']">{stats.similarSum}</span>
            </div>
            <div className="h-12 w-12 rounded-xl bg-emerald-50 dark:bg-emerald-950/70 border border-emerald-100 dark:border-emerald-800 flex items-center justify-center text-emerald-600 dark:text-emerald-300">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6">
      ...
      <div className="space-y-4">
        <div className="border-b border-slate-200 dark:border-slate-800 pb-3 flex items-center justify-between">
          <h2 className="text-xl font-bold text-slate-800 dark:text-white font-['Outfit']">Recent Grievance Filings</h2>
          <span className="text-xs bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 font-bold px-2.5 py-1 rounded-lg">
        ...
        {/* Loading State */}
        {loading && (
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-16 flex justify-center items-center">
